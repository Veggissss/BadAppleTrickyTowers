...
{
    //[HarmonyPatch(typeof(InitGameTypesAndModesCommand))]
    ...
    class AddNewRaceAndNewModesPatch
    {
        ...
        static bool Prefix(InitSinglePlayerChallenge1ModeCommand __instance)
        {
            ...
            BadAppleGameModeFactory badAppleGameModeFactory = new BadAppleGameModeFactory(50f, 50f);
            //badAppleGameModeFactory.brickPickerFactory = new RandomNamedBrickPickerFactory();

            challenges.Add(new BadAppleGameModeModel("sp", "Single Player", badAppleGameModeFactory, "SINGLE_PLAYER_RACE_01"));

            // Add new bad apple mode and old modes as well
            singlePlayerWorldsRef(__instance).Add(new WorldModel("ANY", "SW11", "Bad Apple", challenges));
